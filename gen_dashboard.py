...
Data: Mar 1 – May 6, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-06", 29, 233, 6757),
    ("2026-05-06", 49, 23, 1127),
    ("2026-05-06", 69, 24, 1656),
    ("2026-05-06", 99, 76, 7524),
    ("2026-05-06", 198, 2, 396),
    ("2026-05-06", 199, 71, 14129),
    ("2026-05-06", 249, 33, 8217),
    ("2026-05-06", 449, 34, 15266),
    ("2026-05-06", 489, 1, 489),
    ("2026-05-06", 499, 2, 998),
    ("2026-05-06", 689, 2, 1378),
    ("2026-05-06", 699, 183, 127917),
]
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-07" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ...
    ("2026-02-13", 699, 44, 5, 985),
    ("2026-02-14", 699, 28, 4, 1626),
    ("2026-02-15", 199, 1, 0, None),
    ("2026-02-15", 699, 37, 5, 2155),
    ("2026-02-16", 4, 1, 1, 4),
    ...
    ("2026-04-24", 449, 9920, 1062, 262497),
    ...
    ("2026-04-25", 449, 9262, 1002, 270956),
    ...
    ("2026-04-28", 699, 9885, 682, 293354),
    ...
    ("2026-04-29", 699, 9816, 676, 316978),
    ...
    ("2026-04-30", 699, 10120, 660, 327494),
    ("2026-05-01", 198, 47, 4, 792),
    ("2026-05-01", 199, 294, 20, 3980),
    ("2026-05-01", 449, 89, 3, 1347),
    ("2026-05-01", 489, 43, 0, None),
    ("2026-05-01", 499, 72, 2, 998),
    ("2026-05-01", 689, 71, 3, 2067),
    ("2026-05-01", 699, 9202, 500, 270452),
    ("2026-05-02", 198, 55, 5, 990),
    ("2026-05-02", 199, 357, 19, 3781),
    ("2026-05-02", 449, 56, 2, 898),
    ("2026-05-02", 499, 83, 2, 998),
    ("2026-05-02", 689, 79, 3, 2067),
    ("2026-05-02", 699, 9880, 535, 301916),
    ("2026-05-03", 198, 60, 5, 990),
    ("2026-05-03", 199, 378, 27, 5373),
    ("2026-05-03", 449, 93, 1, 449),
    ("2026-05-03", 499, 82, 3, 1497),
    ("2026-05-03", 689, 93, 1, 689),
    ("2026-05-03", 699, 10268, 470, 273530),
    ("2026-05-04", 198, 68, 3, 594),
    ("2026-05-04", 199, 346, 20, 3980),
    ("2026-05-04", 449, 61, 0, None),
    ("2026-05-04", 499, 95, 3, 1497),
    ("2026-05-04", 689, 45, 1, 689),
    ("2026-05-04", 699, 8877, 378, 245522),
    ("2026-05-05", 198, 42, 2, 396),
    ("2026-05-05", 199, 314, 13, 2587),
    ("2026-05-05", 449, 83, 1, 449),
    ("2026-05-05", 499, 87, 1, 499),
    ("2026-05-05", 689, 28, 0, None),
    ("2026-05-05", 699, 9687, 321, 218129),
    ("2026-05-06", 198, 19, 0, None),
    ("2026-05-06", 199, 185, 14, 2786),
    ("2026-05-06", 449, 45, 0, None),
    ("2026-05-06", 499, 41, 0, None),
    ("2026-05-06", 699, 5501, 183, 127917),
]
...
cohort_raw = [
    ...
    ("03-29", 5878, 250, 2063, 4, 3561, 698),
    ("03-30", 5422, 196, 1846, 2, 3378, 697),
    ("03-31", 6683, 259, 1983, 16, 4425, 697),
    ("04-01", 6521, 228, 2190, 4, 4099, 698),
    ("04-02", 6753, 238, 2272, 12, 4231, 699),
    ("04-03", 6939, 240, 2223, 12, 4464, 699),
    ("04-04", 6854, 210, 2249, 10, 4385, 699),
    ("04-05", 7463, 285, 2313, 6, 4859, 699),
    ("04-06", 7386, 250, 2326, 5, 4805, 698),
    ...
    ("04-15", 8327, 328, 2475, 70, 5454, 684),
    ...
    ("04-25", 9722, 383, 2888, 3909, 2542, 447),
    ...
    ("05-01", 9818, 331, 2803, 4124, 2560, 677),
    ("05-02", 10510, 381, 2910, 4445, 2774, 676),
    ("05-03", 10974, 347, 3103, 4667, 2857, 675),
    ("05-04", 9492, 334, 2760, 3903, 2495, 674),
    ("05-05", 10241, 311, 2796, 4349, 2733, 678),
    ("05-06", 5791, 197, 948, 2318, 2244, 678),
]
