...
Data: Mar 1 – May 3, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-02", 689, 2, 1378),
    ("2026-05-02", 699, 360, 251640),
    ("2026-05-03", 29, 105, 3045),
    ("2026-05-03", 49, 17, 833),
    ("2026-05-03", 69, 5, 345),
    ("2026-05-03", 99, 26, 2574),
    ("2026-05-03", 199, 25, 4975),
    ("2026-05-03", 249, 9, 2241),
    ("2026-05-03", 449, 12, 5388),
    ("2026-05-03", 689, 1, 689),
    ("2026-05-03", 699, 44, 30756),
]
...
att1_daily = {
    ...
    "2026-04-28": (10683, 324),
    "2026-04-29": (10468, 361),
    "2026-04-30": (10666, 368),
    "2026-05-01": (9805, 332),
    "2026-05-02": (10508, 379),
    "2026-05-03": (3336, 48),
}
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-04" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
cohort_raw = [
    ...
    ("04-28", 10643, 319, 3135, 4298, 2891, 675),
    ("04-29", 10423, 361, 3261, 4222, 2579, 680),
    ("04-30", 10627, 368, 3065, 4428, 2766, 682),
    ("05-01", 9771, 331, 2800, 4123, 2517, 678),
    ("05-02", 10471, 378, 2889, 4432, 2772, 676),
    ("05-03", 3332, 48, 268, 733, 2283, 677),
]
