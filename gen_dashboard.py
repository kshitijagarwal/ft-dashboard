...
Data: Mar 1 – May 5, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-04", 689, 1, 689),
    ("2026-05-04", 699, 313, 218787),
    ("2026-05-05", 29, 339, 9831),
    ("2026-05-05", 49, 39, 1911),
    ("2026-05-05", 69, 38, 2622),
    ("2026-05-05", 99, 88, 8712),
    ("2026-05-05", 198, 2, 396),
    ("2026-05-05", 199, 47, 9353),
    ("2026-05-05", 249, 46, 11454),
    ("2026-05-05", 449, 34, 15266),
    ("2026-05-05", 499, 1, 499),
    ("2026-05-05", 699, 191, 133509),
]
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-06" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ...
    ("2026-03-06", 699, 921, 99, 43761),
    ("2026-03-07", 449, 7, 0, None),
    ("2026-03-07", 699, 1247, 141, 62599),
    ...
    ("2026-04-24", 449, 9920, 1025, 260380),
...
cohort_raw = [
    ...
    ("03-03", 559, 30, 208, 12, 309, 696),
    ("03-04", 469, 22, 173, 2, 272, 695),
    ("03-05", 389, 11, 143, 2, 233, 697),
    ("03-06", 928, 31, 334, 6, 557, 697),
    ...
    ("03-24", 4136, 173, 1373, 2, 2588, 695),
    ("03-25", 4108, 170, 1432, 4, 2502, 695),
    ("03-26", 4200, 173, 1331, 5, 2691, 697),
    ("03-27", 4636, 215, 1551, 3, 2867, 698),
    ("03-28", 4413, 191, 1546, 4, 2672, 697),
    ("03-29", 5878, 250, 2063, 4, 3561, 698),
    ("03-30", 5422, 196, 1846, 2, 3378, 697),
    ("03-31", 6683, 259, 1983, 16, 4425, 697),
    ("04-01", 6519, 228, 2189, 4, 4098, 698),
    ("04-02", 6751, 238, 2272, 11, 4230, 699),
    ...
    ("04-30", 10676, 369, 3065, 4430, 2812, 681),
    ("05-01", 9774, 331, 2802, 4124, 2517, 678),
    ("05-02", 10509, 381, 2910, 4445, 2773, 676),
    ("05-03", 10974, 347, 3103, 4667, 2857, 675),
    ("05-04", 9474, 333, 2748, 3898, 2495, 673),
    ("05-05", 7053, 193, 1277, 3020, 2407, 680),
]
