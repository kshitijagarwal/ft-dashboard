...
Data: Mar 1 – May 12, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-11", 689, 3, 2067),
    ("2026-05-11", 699, 468, 327132),
    ("2026-05-12", 198, 1, 198),
    ("2026-05-12", 199, 11, 2189),
    ("2026-05-12", 249, 16, 3984),
    ("2026-05-12", 449, 19, 8531),
    ("2026-05-12", 489, 1, 489),
    ("2026-05-12", 689, 1, 689),
    ("2026-05-12", 699, 149, 104151),
]
...
att1_daily = {
    ...
    "2026-05-01": (9867, 332),
    "2026-05-02": (10649, 383),
    "2026-05-03": (11095, 347),
    "2026-05-04": (9601, 338),
    "2026-05-05": (10379, 317),
    "2026-05-06": (9859, 341),
    "2026-05-07": (9613, 319),
    "2026-05-08": (10067, 303),
    "2026-05-09": (9661, 300),
    "2026-05-10": (8877, 329),
    "2026-05-11": (9575, 323),
    "2026-05-12": (6856, 136),
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-13" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ("2026-02-01", 699, 29, 2, 478),
    ("2026-02-02", 199, 2, 1, 199),
    ("2026-02-02", 449, 3, 0, None),
    ("2026-02-02", 699, 22, 4, 2796),
    ("2026-02-03", 199, 1, 0, None),
    ("2026-02-03", 449, 3, 0, None),
    ("2026-02-03", 699, 35, 1, 699),
    ("2026-02-04", 699, 32, 0, None),
    ("2026-02-05", 449, 2, 0, None),
    ("2026-02-05", 489, 1, 0, None),
    ("2026-02-05", 699, 42, 9, 931),
    ("2026-02-06", 699, 29, 2, 898),
    ("2026-02-07", 199, 2, 0, None),
    ("2026-02-07", 449, 1, 0, None),
    ("2026-02-07", 499, 1, 0, None),
    ("2026-02-07", 699, 19, 2, 1398),
    ("2026-02-08", 199, 1, 0, None),
    ("2026-02-08", 449, 2, 0, None),
    ("2026-02-08", 699, 29, 3, 757),
    ("2026-02-09", 449, 4, 0, None),
    ("2026-02-09", 699, 45, 5, 2155),
    ("2026-02-10", 199, 1, 0, None),
    ("2026-02-10", 449, 1, 0, None),
    ("2026-02-10", 699, 36, 11, 2019),
    ("2026-02-11", 199, 1, 0, None),
    ("2026-02-11", 449, 1, 0, None),
    ("2026-02-11", 699, 33, 6, 514),
    ("2026-02-12", 449, 2, 0, None),
    ("2026-02-12", 699, 38, 4, 786),
    ("2026-02-13", 199, 1, 0, None),
    ("2026-02-13", 449, 1, 0, None),
    ("2026-02-13", 699, 45, 6, 1014),
    ("2026-02-14", 699, 31, 5, 2325),
    ("2026-02-15", 199, 1, 0, None),
    ("2026-02-15", 699, 38, 5, 2155),
    ("2026-02-16", 4, 1, 1, 4),
    ("2026-02-16", 198, 1, 1, 198),
    ("2026-02-16", 449, 3, 2, 498),
    ("2026-02-16", 699, 36, 2, 1398),
    ("2026-02-17", 4, 2, 2, 8),
    ("2026-02-17", 199, 3, 0, None),
    ("2026-02-17", 449, 3, 0, None),
    ("2026-02-17", 699, 36, 3, 1597),
    ("2026-02-18", 4, 1, 1, 4),
    ("2026-02-18", 699, 90, 10, 3880),
    ("2026-02-19", 4, 15, 5, 20),
    ("2026-02-19", 5, 1, 1, 5),
    ("2026-02-19", 199, 2, 1, 199),
    ("2026-02-19", 449, 2, 0, None),
    ("2026-02-19", 699, 69, 9, 2941),
    ("2026-02-20", 4, 3, 3, 12),
    ("2026-02-20", 199, 1, 0, None),
    ("2026-02-20", 449, 3, 0, None),
    ("2026-02-20", 699, 60, 8, 3652),
    ("2026-02-21", 449, 1, 0, None),
    ("2026-02-21", 699, 125, 6, 2354),
    ("2026-02-22", 449, 2, 0, None),
    ("2026-02-22", 699, 193, 15, 6635),
    ("2026-02-23", 199, 1, 0, None),
    ("2026-02-23", 449, 3, 1, 449),
    ("2026-02-23", 699, 263, 23, 10047),
    ("2026-02-24", 449, 5, 0, None),
    ("2026-02-24", 699, 460, 24, 13836),
    ("2026-02-25", 199, 1, 0, None),
    ("2026-02-25", 449, 2, 0, None),
    ("2026-02-25", 699, 663, 32, 18018),
    ("2026-02-26", 449, 6, 0, None),
    ("2026-02-26", 699, 885, 62, 33371),
    ("2026-02-27", 198, 1, 0, None),
    ("2026-02-27", 199, 4, 0, None),
    ("2026-02-27", 449, 7, 0, None),
    ("2026-02-27", 699, 1360, 124, 60489),
    ("2026-02-28", 199, 2, 0, None),
    ("2026-02-28", 449, 8, 1, 199),
    ("2026-02-28", 699, 1257, 82, 45428),
    ("2026-03-01", 199, 1, 0, None),
    ("2026-03-01", 449, 4, 0, None),
    ("2026-03-01", 699, 345, 34, 19076),
    ("2026-03-02", 5, 2, 2, 10),
    ("2026-03-02", 449, 6, 0, None),
    ("2026-03-02", 699, 395, 48, 22232),
    ("2026-03-03", 199, 1, 0, None),
    ("2026-03-03", 449, 5, 0, None),
    ("2026-03-03", 699, 560, 54, 31076),
    ("2026-03-04", 199, 2, 1, 199),
    ("2026-03-04", 449, 4, 0, None),
    ("2026-03-04", 699, 467, 53, 21787),
    ("2026-03-05", 199, 1, 0, None),
    ("2026-03-05", 449, 3, 0, None),
    ("2026-03-05", 699, 387, 30, 15610),
    ("2026-03-06", 449, 7, 0, None),
    ("2026-03-06", 689, 1, 0, None),
    ("2026-03-06", 699, 925, 101, 43819),
    ("2026-03-07", 449, 7, 1, 29),
    ("2026-03-07", 699, 1248, 146, 62744),
    ("2026-03-08", 199, 1, 0, None),
    ("2026-03-08", 449, 2, 0, None),
    ("2026-03-08", 699, 1051, 120, 52100),
    ("2026-03-09", 199, 1, 0, None),
    ("2026-03-09", 449, 3, 0, None),
    ("2026-03-09", 699, 913, 86, 46454),
    ("2026-03-10", 199, 1, 0, None),
    ("2026-03-10", 449, 5, 0, None),
    ("2026-03-10", 699, 205, 13, 8117),
    ("2026-03-11", 5, 1, 0, None),
    ("2026-03-11", 449, 5, 1, 449),
    ("2026-03-11", 499, 1, 0, None),
    ("2026-03-11", 699, 412, 54, 26376),
    ("2026-03-11", 999, 1, 0, None),
    ("2026-03-12", 449, 7, 0, None),
    ("2026-03-12", 699, 515, 51, 25489),
    ("2026-03-13", 5, 1, 1, 5),
    ("2026-03-13", 449, 5, 0, None),
    ("2026-03-13", 699, 1115, 131, 61469),
    ("2026-03-14", 449, 5, 0, None),
    ("2026-03-14", 699, 1860, 183, 75180),
    ("2026-03-15", 199, 2, 0, None),
    ("2026-03-15", 449, 5, 0, None),
    ("2026-03-15", 699, 2794, 295, 136458),
    ("2026-03-16", 5, 2, 0, None),
    ("2026-03-16", 199, 3, 0, None),
    ("2026-03-16", 449, 4, 0, None),
    ("2026-03-16", 699, 2539, 274, 119339),
    ("2026-03-17", 10, 6, 4, 40),
    ("2026-03-17", 199, 1, 1, 199),
    ("2026-03-17", 449, 5, 0, None),
    ("2026-03-17", 699, 3525, 399, 173574),
    ("2026-03-17", 999, 1, 1, 999),
    ("2026-03-18", 199, 2, 2, 398),
    ("2026-03-18", 449, 7, 0, None),
    ("2026-03-18", 699, 4328, 400, 186143),
    ("2026-03-19", 10, 6, 4, 40),
    ("2026-03-19", 449, 5, 0, None),
    ("2026-03-19", 699, 3925, 389, 174584),
    ("2026-03-20", 449, 2, 0, None),
    ("2026-03-20", 699, 3092, 320, 151430),
    ("2026-03-21", 449, 2, 0, None),
    ("2026-03-21", 689, 1, 0, None),
    ("2026-03-21", 699, 3047, 326, 157307),
    ("2026-03-22", 449, 5, 0, None),
    ("2026-03-22", 699, 3208, 364, 158302),
    ("2026-03-23", 199, 23, 4, 796),
    ("2026-03-23", 699, 3419, 366, 169514),
    ("2026-03-24", 199, 26, 6, 1194),
    ("2026-03-24", 249, 10, 0, None),
    ("2026-03-24", 449, 2, 0, None),
    ("2026-03-24", 699, 4101, 508, 221698),
    ("2026-03-25", 199, 1, 0, None),
    ("2026-03-25", 249, 33, 4, 996),
    ("2026-03-25", 449, 6, 0, None),
    ("2026-03-25", 499, 1, 0, None),
    ("2026-03-25", 699, 4069, 522, 214668),
    ("2026-03-26", 10, 5, 0, None),
    ("2026-03-26", 199, 1, 0, None),
    ("2026-03-26", 249, 9, 1, 249),
    ("2026-03-26", 449, 6, 0, None),
    ("2026-03-26", 699, 4179, 481, 198809),
    ("2026-03-27", 10, 1, 0, None),
    ("2026-03-27", 199, 4, 0, None),
    ("2026-03-27", 249, 4, 0, None),
    ("2026-03-27", 449, 3, 0, None),
    ("2026-03-27", 699, 4625, 656, 274547),
    ("2026-03-28", 199, 1, 0, None),
    ("2026-03-28", 249, 13, 2, 498),
    ("2026-03-28", 449, 2, 0, None),
    ("2026-03-28", 499, 2, 0, None),
    ("2026-03-28", 699, 4400, 586, 229130),
    ("2026-03-29", 199, 1, 0, None),
    ("2026-03-29", 249, 11, 0, None),
    ("2026-03-29", 449, 5, 0, None),
    ("2026-03-29", 699, 5860, 806, 290500),
    ("2026-03-30", 199, 2, 0, None),
    ("2026-03-30", 249, 16, 3, 747),
    ("2026-03-30", 449, 6, 2, 368),
    ("2026-03-30", 699, 5400, 724, 245215),
    ("2026-03-31", 199, 2, 0, None),
    ("2026-03-31", 249, 24, 3, 747),
    ("2026-03-31", 449, 4, 0, None),
    ("2026-03-31", 689, 2, 0, None),
    ("2026-03-31", 699, 6653, 847, 297611),
    ("2026-04-01", 199, 1, 0, None),
    ("2026-04-01", 249, 17, 1, 249),
    ("2026-04-01", 449, 8, 0, None),
    ("2026-04-01", 699, 6502, 821, 273424),
    ("2026-04-02", 199, 1, 0, None),
    ("2026-04-02", 249, 4, 0, None),
    ("2026-04-02", 449, 6, 0, None),
    ("2026-04-02", 699, 6742, 902, 280053),
    ("2026-04-03", 199, 2, 1, 199),
    ("2026-04-03", 449, 9, 2, 699),
    ("2026-04-03", 699, 6932, 798, 262484),
    ("2026-04-04", 199, 1, 1, 199),
    ("2026-04-04", 449, 11, 0, None),
    ("2026-04-04", 699, 6844, 855, 259520),
    ("2026-04-05", 199, 2, 0, None),
    ("2026-04-05", 449, 10, 0, None),
    ("2026-04-05", 699, 7456, 963, 321645),
    ("2026-04-06", 199, 14, 0, None),
    ("2026-04-06", 449, 5, 1, 49),
    ("2026-04-06", 699, 7368, 995, 285500),
    ("2026-04-07", 199, 50, 3, 597),
    ("2026-04-07", 699, 8174, 1113, 332729),
    ("2026-04-08", 199, 156, 19, 3611),
    ("2026-04-08", 449, 2, 0, None),
    ("2026-04-08", 489, 1, 0, None),
    ("2026-04-08", 499, 1, 0, None),
    ("2026-04-08", 699, 7585, 1090, 301570),
    ("2026-04-09", 199, 252, 23, 4577),
    ("2026-04-09", 449, 2, 0, None),
    ("2026-04-09", 699, 8157, 1213, 327626),
    ("2026-04-10", 199, 186, 12, 2388),
    ("2026-04-10", 699, 7644, 1158, 320102),
    ("2026-04-11", 199, 187, 19, 3781),
    ("2026-04-11", 699, 7304, 1179, 336698),
    ("2026-04-12", 199, 367, 27, 5373),
    ("2026-04-12", 699, 7615, 1193, 356150),
    ("2026-04-13", 199, 319, 30, 5970),
    ("2026-04-13", 699, 6969, 1133, 301711),
    ("2026-04-14", 199, 262, 20, 3980),
    ("2026-04-14", 449, 2, 0, None),
    ("2026-04-14", 699, 7893, 1118, 308802),
    ("2026-04-15", 199, 241, 18, 3582),
    ("2026-04-15", 449, 1, 0, None),
    ("2026-04-15", 689, 1, 0, None),
    ("2026-04-15", 699, 8085, 1185, 321366),
    ("2026-04-16", 199, 332, 27, 5373),
    ("2026-04-16", 449, 3, 0, None),
    ("2026-04-16", 699, 9164, 1276, 330785),
    ("2026-04-17", 199, 316, 28, 5572),
    ("2026-04-17", 499, 1, 1, 499),
    ("2026-04-17", 699, 10020, 1369, 357617),
    ("2026-04-18", 199, 285, 31, 6169),
    ("2026-04-18", 699, 8699, 1168, 337462),
    ("2026-04-19", 199, 309, 30, 5970),
    ("2026-04-19", 449, 3, 0, None),
    ("2026-04-19", 699, 9523, 1162, 339205),
    ("2026-04-20", 199, 193, 15, 2985),
    ("2026-04-20", 449, 1, 0, None),
    ("2026-04-20", 699, 8854, 1076, 296775),
    ("2026-04-21", 199, 227, 20, 3980),
    ("2026-04-21", 449, 4, 1, 29),
    ("2026-04-21", 699, 9027, 1058, 315380),
    ("2026-04-22", 198, 1, 0, None),
    ("2026-04-22", 199, 208, 19, 3781),
    ("2026-04-22", 449, 2579, 335, 80426),
    ("2026-04-22", 689, 11, 0, None),
    ("2026-04-22", 699, 6613, 760, 223848),
    ("2026-04-23", 198, 89, 2, 396),
    ("2026-04-23", 199, 226, 23, 4577),
    ("2026-04-23", 449, 10561, 1314, 313760),
    ("2026-04-23", 489, 96, 5, 2445),
    ("2026-04-23", 499, 118, 4, 1996),
    ("2026-04-23", 689, 201, 4, 2756),
    ("2026-04-24", 198, 84, 5, 990),
    ("2026-04-24", 199, 246, 15, 2985),
    ("2026-04-24", 449, 9919, 1170, 279379),
    ("2026-04-24", 489, 95, 4, 1956),
    ("2026-04-24", 499, 117, 4, 1996),
    ("2026-04-24", 689, 93, 4, 2756),
    ("2026-04-24", 699, 7, 0, None),
    ("2026-04-25", 198, 66, 6, 1188),
    ("2026-04-25", 199, 133, 10, 1990),
    ("2026-04-25", 449, 9262, 1125, 288475),
    ("2026-04-25", 489, 83, 0, None),
    ("2026-04-25", 499, 95, 1, 499),
    ("2026-04-25", 689, 82, 2, 1378),
    ("2026-04-25", 699, 2, 0, None),
    ("2026-04-26", 198, 73, 2, 396),
    ("2026-04-26", 199, 396, 22, 4378),
    ("2026-04-26", 449, 10411, 1139, 308254),
    ("2026-04-26", 489, 138, 6, 2934),
    ("2026-04-26", 499, 141, 2, 998),
    ("2026-04-26", 689, 128, 8, 5512),
    ("2026-04-26", 699, 1, 0, None),
    ("2026-04-27", 198, 60, 5, 990),
    ("2026-04-27", 199, 292, 15, 2985),
    ("2026-04-27", 449, 7405, 779, 212008),
    ("2026-04-27", 489, 116, 4, 1956),
    ("2026-04-27", 499, 142, 3, 1497),
    ("2026-04-27", 689, 122, 1, 689),
    ("2026-04-27", 699, 3013, 256, 83390),
    ("2026-04-28", 198, 52, 2, 396),
    ("2026-04-28", 199, 327, 25, 4975),
    ("2026-04-28", 449, 97, 5, 2245),
    ("2026-04-28", 489, 139, 2, 978),
    ("2026-04-28", 499, 81, 5, 2495),
    ("2026-04-28", 689, 100, 2, 1378),
    ("2026-04-28", 699, 9885, 826, 316045),
    ("2026-04-29", 198, 57, 8, 1584),
    ("2026-04-29", 199, 253, 16, 3184),
    ("2026-04-29", 449, 96, 3, 1347),
    ("2026-04-29", 489, 109, 3, 1467),
    ("2026-04-29", 499, 104, 1, 499),
    ("2026-04-29", 689, 99, 3, 2067),
    ("2026-04-29", 699, 9816, 792, 337717),
    ("2026-04-30", 198, 37, 2, 396),
    ("2026-04-30", 199, 266, 12, 2388),
    ("2026-04-30", 449, 65, 3, 1347),
    ("2026-04-30", 489, 64, 2, 978),
    ("2026-04-30", 499, 73, 3, 1497),
    ("2026-04-30", 689, 69, 4, 2756),
    ("2026-04-30", 699, 10121, 777, 351731),
    ("2026-05-01", 198, 47, 4, 792),
    ("2026-05-01", 199, 294, 23, 4577),
    ("2026-05-01", 449, 89, 3, 1347),
    ("2026-05-01", 489, 62, 1, 489),
    ("2026-05-01", 499, 72, 2, 998),
    ("2026-05-01", 689, 71, 4, 2756),
    ("2026-05-01", 699, 9203, 632, 303029),
    ("2026-05-02", 198, 55, 5, 990),
    ("2026-05-02", 199, 357, 23, 4577),
    ("2026-05-02", 449, 56, 2, 898),
    ("2026-05-02", 489, 102, 2, 978),
    ("2026-05-02", 499, 83, 2, 998),
    ("2026-05-02", 689, 79, 3, 2067),
    ("2026-05-02", 699, 9880, 644, 332059),
    ("2026-05-03", 198, 60, 5, 990),
    ("2026-05-03", 199, 378, 33, 6567),
    ("2026-05-03", 449, 93, 1, 449),
    ("2026-05-03", 489, 90, 1, 489),
    ("2026-05-03", 499, 82, 3, 1497),
    ("2026-05-03", 689, 93, 2, 1378),
    ("2026-05-03", 699, 10268, 614, 319040),
    ("2026-05-04", 198, 68, 3, 594),
    ("2026-05-04", 199, 346, 24, 4776),
    ("2026-05-04", 449, 61, 0, None),
    ("2026-05-04", 489, 79, 5, 2445),
    ("2026-05-04", 499, 95, 3, 1497),
    ("2026-05-04", 689, 45, 1, 689),
    ("2026-05-04", 699, 8882, 523, 296880),
    ("2026-05-05", 198, 42, 3, 594),
    ("2026-05-05", 199, 314, 20, 3980),
    ("2026-05-05", 449, 83, 1, 449),
    ("2026-05-05", 489, 75, 2, 978),
    ("2026-05-05", 499, 87, 2, 998),
    ("2026-05-05", 689, 48, 2, 1378),
    ("2026-05-05", 699, 9692, 511, 295740),
    ("2026-05-06", 198, 32, 0, None),
    ("2026-05-06", 199, 386, 31, 6169),
    ("2026-05-06", 449, 66, 2, 898),
    ("2026-05-06", 489, 94, 2, 978),
    ("2026-05-06", 499, 83, 3, 1497),
    ("2026-05-06", 689, 48, 0, None),
    ("2026-05-06", 699, 9121, 489, 293414),
    ("2026-05-07", 198, 41, 1, 198),
    ("2026-05-07", 199, 330, 22, 4378),
    ("2026-05-07", 449, 66, 0, None),
    ("2026-05-07", 489, 54, 0, None),
    ("2026-05-07", 499, 68, 1, 499),
    ("2026-05-07", 689, 88, 3, 2067),
    ("2026-05-07", 699, 8943, 459, 275594),
    ("2026-05-08", 198, 36, 1, 198),
    ("2026-05-08", 199, 382, 29, 5771),
    ("2026-05-08", 449, 67, 3, 1347),
    ("2026-05-08", 499, 64, 0, None),
    ("2026-05-08", 689, 60, 1, 689),
    ("2026-05-08", 699, 9431, 429, 251421),
    ("2026-05-09", 198, 36, 1, 198),
    ("2026-05-09", 199, 380, 28, 5572),
    ("2026-05-09", 449, 62, 3, 1347),
    ("2026-05-09", 499, 55, 2, 998),
    ("2026-05-09", 689, 77, 2, 1378),
    ("2026-05-09", 699, 9036, 395, 235255),
    ("2026-05-10", 198, 31, 2, 396),
    ("2026-05-10", 199, 357, 25, 4975),
    ("2026-05-10", 449, 60, 2, 898),
    ("2026-05-10", 499, 56, 3, 1497),
    ("2026-05-10", 689, 84, 0, None),
    ("2026-05-10", 699, 8261, 350, 232900),
    ("2026-05-11", 198, 51, 0, None),
    ("2026-05-11", 199, 368, 23, 4577),
    ("2026-05-11", 449, 54, 3, 1347),
    ("2026-05-11", 499, 70, 3, 1497),
    ("2026-05-11", 689, 38, 0, None),
    ("2026-05-11", 699, 8977, 301, 209399),
    ("2026-05-12", 198, 9, 1, 198),
    ("2026-05-12", 199, 143, 8, 1592),
    ("2026-05-12", 449, 38, 0, None),
    ("2026-05-12", 499, 23, 0, None),
    ("2026-05-12", 689, 3, 0, None),
    ("2026-05-12", 699, 6642, 127, 88773),
]
...
cohort_raw = [
    ("03-01", 350, 24, 99, 3, 224, 695),
    ("03-02", 403, 20, 156, 5, 222, 692),
    ("03-03", 566, 30, 212, 14, 310, 696),
    ("03-04", 473, 22, 174, 3, 274, 695),
    ("03-05", 391, 11, 143, 4, 233, 696),
    ("03-06", 933, 31, 336, 8, 558, 697),
    ("03-07", 1255, 51, 418, 4, 782, 698),
    ("03-08", 1054, 52, 341, 4, 657, 698),
    ("03-09", 917, 37, 311, 7, 562, 698),
    ("03-10", 211, 8, 83, 6, 114, 691),
    ("03-11", 420, 23, 173, 3, 221, 695),
    ("03-12", 522, 28, 199, 4, 291, 696),
    ("03-13", 1121, 53, 393, 3, 672, 697),
    ("03-14", 1865, 68, 633, 5, 1159, 698),
    ("03-15", 2801, 124, 893, 5, 1779, 698),
    ("03-16", 2548, 105, 836, 10, 1597, 697),
    ("03-17", 3538, 162, 1138, 12, 2226, 697),
    ("03-18", 4337, 176, 1335, 8, 2818, 698),
    ("03-19", 3936, 161, 1183, 12, 2580, 698),
    ("03-20", 3094, 132, 978, 5, 1979, 699),
    ("03-21", 3050, 156, 901, 4, 1989, 699),
    ("03-22", 3213, 150, 963, 4, 2096, 699),
    ("03-23", 3442, 156, 1087, 0, 2199, 696),
    ("03-24", 4139, 173, 1375, 2, 2589, 695),
    ("03-25", 4110, 170, 1434, 4, 2502, 695),
    ("03-26", 4200, 173, 1331, 5, 2691, 697),
    ("03-27", 4637, 215, 1552, 3, 2867, 698),
    ("03-28", 4418, 191, 1548, 6, 2673, 697),
    ("03-29", 5877, 250, 2063, 4, 3560, 698),
    ("03-30", 5424, 196, 1847, 2, 3379, 697),
    ("03-31", 6685, 259, 1984, 17, 4425, 697),
    ("04-01", 6528, 228, 2194, 5, 4101, 697),
    ("04-02", 6753, 238, 2273, 12, 4230, 698),
    ("04-03", 6943, 240, 2225, 12, 4466, 699),
    ("04-04", 6856, 210, 2249, 10, 4387, 699),
    ("04-05", 7468, 286, 2315, 8, 4859, 699),
    ("04-06", 7387, 250, 2326, 5, 4806, 698),
    ("04-07", 8224, 304, 2389, 8, 5523, 696),
    ("04-08", 7745, 291, 2313, 173, 4968, 689),
    ("04-09", 8411, 321, 2553, 70, 5467, 684),
    ("04-10", 7830, 304, 2326, 2, 5198, 687),
    ("04-11", 7491, 343, 2218, 0, 4930, 687),
    ("04-12", 7982, 376, 2320, 3, 5283, 676),
    ("04-13", 7288, 300, 2350, 1, 4637, 677),
    ("04-14", 8157, 329, 2433, 240, 5155, 683),
    ("04-15", 8328, 328, 2475, 70, 5455, 684),
    ("04-16", 9499, 327, 2900, 13, 6259, 681),
    ("04-17", 10337, 363, 3268, 2, 6704, 684),
    ("04-18", 8984, 344, 2829, 4, 5807, 683),
    ("04-19", 9835, 345, 3003, 5, 6482, 683),
    ("04-20", 9048, 288, 2795, 16, 5949, 688),
    ("04-21", 9258, 338, 2831, 11, 6078, 687),
    ("04-22", 9412, 339, 2845, 2, 6226, 619),
    ("04-23", 11291, 436, 3335, 2770, 4750, 447),
    ("04-24", 10561, 382, 3084, 4270, 2825, 444),
    ("04-25", 9723, 383, 2889, 3909, 2542, 447),
    ("04-26", 11288, 438, 3192, 4835, 2823, 442),
    ("04-27", 11150, 363, 3292, 4476, 3019, 512),
    ("04-28", 10681, 321, 3165, 4300, 2895, 675),
    ("04-29", 10534, 362, 3286, 4222, 2664, 678),
    ("04-30", 10695, 371, 3080, 4431, 2813, 681),
    ("05-01", 9838, 331, 2817, 4130, 2560, 677),
    ("05-02", 10612, 382, 2921, 4451, 2858, 675),
    ("05-03", 11064, 347, 3121, 4669, 2927, 674),
    ("05-04", 9576, 337, 2779, 3908, 2552, 672),
    ("05-05", 10341, 312, 2836, 4412, 2781, 677),
    ("05-06", 9830, 341, 2738, 4033, 2718, 672),
    ("05-07", 9590, 318, 2684, 3668, 2920, 675),
    ("05-08", 10040, 300, 2775, 4041, 2924, 675),
    ("05-09", 9646, 301, 2483, 3870, 2992, 675),
    ("05-10", 8849, 327, 2095, 4047, 2380, 674),
    ("05-11", 9558, 322, 2407, 4231, 2598, 674),
    ("05-12", 6858, 135, 372, 2772, 3181, 686),
]
