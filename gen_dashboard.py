...
daily_raw = [
    ...
    ("2026-05-06", 29, 103, 2987),
    ("2026-05-06", 49, 8, 392),
    ("2026-05-06", 69, 7, 483),
    ("2026-05-06", 99, 28, 2772),
    ("2026-05-06", 198, 1, 198),
    ("2026-05-06", 199, 25, 4975),
    ("2026-05-06", 249, 15, 3735),
    ("2026-05-06", 449, 16, 7184),
    ("2026-05-06", 489, 1, 489),
    ("2026-05-06", 499, 1, 499),
    ("2026-05-06", 699, 46, 32154),
]
...
pivot_cohort_raw = [
    ...
    ("2026-04-24", 449, 9920, 1051, 262038),
    ...
    ("2026-04-25", 449, 9262, 990, 270608),
    ...
    ("2026-04-26", 449, 10412, 968, 286925),
    ...
    ("2026-04-27", 449, 7405, 625, 192371),
    ...
    ("2026-04-28", 699, 9884, 666, 292250),
...
cohort_raw = [
    ...
    ("05-05", 10241, 311, 2796, 4341, 2689, 678),
    ("05-06", 2969, 52, 183, 608, 2041, 674),
]
