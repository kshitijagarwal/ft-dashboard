...
Data: Mar 1 – May 11, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-06", 489, 1, 489),
    ("2026-05-06", 499, 4, 1996),
    ("2026-05-06", 689, 2, 1378),
    ("2026-05-06", 699, 313, 218787),
    ("2026-05-07", 1, 1, 1),
    ...
    ("2026-05-09", 449, 81, 36369),
    ("2026-05-09", 499, 3, 1497),
    ("2026-05-09", 689, 3, 2067),
    ("2026-05-09", 699, 343, 239757),
    ...
    ("2026-05-10", 249, 94, 23406),
    ("2026-05-10", 250, 14, 3500),
    ("2026-05-10", 299, 1, 299),
    ("2026-05-10", 449, 100, 44900),
    ("2026-05-10", 489, 2, 978),
    ("2026-05-10", 499, 4, 1996),
    ("2026-05-10", 689, 1, 689),
    ("2026-05-10", 699, 404, 282396),
    ("2026-05-11", 198, 1, 198),
    ("2026-05-11", 199, 3, 597),
    ("2026-05-11", 249, 15, 3735),
    ("2026-05-11", 449, 14, 6286),
    ("2026-05-11", 489, 2, 978),
    ("2026-05-11", 699, 74, 51726),
]
...
att1_daily = {
    ...
    "2026-05-01": (9867, 332),
    "2026-05-02": (10649, 384),
    "2026-05-03": (11095, 347),
    "2026-05-04": (9601, 338),
    "2026-05-05": (10379, 317),
    "2026-05-06": (9835, 338),
    "2026-05-07": (9559, 312),
    "2026-05-08": (10067, 297),
    "2026-05-09": (9661, 283),
    "2026-05-10": (8848, 315),
    "2026-05-11": (3584, 45),
}
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-12" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ...
    ("2026-03-13", 699, 1115, 130, 61440),
    ("2026-03-14", 449, 5, 0, None),
    ("2026-03-14", 699, 1859, 183, 75180),
    ...
    ("2026-04-28", 699, 9885, 817, 311872),
    ...
    ("2026-05-01", 699, 9202, 621, 296687),
    ...
    ("2026-05-02", 699, 9880, 634, 326919),
    ("2026-05-03", 198, 60, 5, 990),
    ("2026-05-03", 199, 378, 32, 6368),
    ("2026-05-03", 449, 93, 1, 449),
    ("2026-05-03", 489, 90, 0, None),
    ("2026-05-03", 499, 82, 3, 1497),
    ("2026-05-03", 689, 93, 2, 1378),
    ("2026-05-03", 699, 10268, 600, 311553),
    ("2026-05-04", 198, 68, 3, 594),
    ("2026-05-04", 199, 346, 23, 4577),
    ("2026-05-04", 449, 61, 0, None),
    ("2026-05-04", 489, 79, 4, 1956),
    ("2026-05-04", 499, 95, 3, 1497),
    ("2026-05-04", 689, 45, 1, 689),
    ("2026-05-04", 699, 8882, 512, 290141),
    ("2026-05-05", 198, 42, 3, 594),
    ("2026-05-05", 199, 314, 18, 3582),
    ("2026-05-05", 449, 83, 1, 449),
    ("2026-05-05", 489, 75, 1, 489),
    ("2026-05-05", 499, 87, 2, 998),
    ("2026-05-05", 689, 48, 1, 689),
    ("2026-05-05", 699, 9692, 493, 284757),
    ("2026-05-06", 198, 32, 0, None),
    ("2026-05-06", 199, 386, 30, 5970),
    ("2026-05-06", 449, 66, 2, 898),
    ("2026-05-06", 489, 70, 0, None),
    ("2026-05-06", 499, 83, 2, 998),
    ("2026-05-06", 689, 48, 0, None),
    ("2026-05-06", 699, 9121, 476, 284327),
    ("2026-05-07", 198, 41, 1, 198),
    ("2026-05-07", 199, 330, 22, 4378),
    ("2026-05-07", 449, 66, 0, None),
    ("2026-05-07", 499, 68, 1, 499),
    ("2026-05-07", 689, 88, 2, 1378),
    ("2026-05-07", 699, 8942, 430, 256472),
    ("2026-05-08", 198, 36, 1, 198),
    ("2026-05-08", 199, 382, 29, 5771),
    ("2026-05-08", 449, 67, 3, 1347),
    ("2026-05-08", 499, 64, 0, None),
    ("2026-05-08", 689, 60, 1, 689),
    ("2026-05-08", 699, 9431, 395, 232655),
    ("2026-05-09", 198, 36, 1, 198),
    ("2026-05-09", 199, 380, 24, 4776),
    ("2026-05-09", 449, 62, 2, 898),
    ("2026-05-09", 499, 55, 2, 998),
    ("2026-05-09", 689, 77, 2, 1378),
    ("2026-05-09", 699, 9036, 312, 202888),
    ("2026-05-10", 198, 31, 2, 396),
    ("2026-05-10", 199, 357, 23, 4577),
    ("2026-05-10", 449, 60, 2, 898),
    ("2026-05-10", 499, 56, 3, 1497),
    ("2026-05-10", 689, 55, 0, None),
    ("2026-05-10", 699, 8261, 289, 201261),
    ("2026-05-11", 198, 8, 0, None),
    ("2026-05-11", 199, 107, 3, 597),
    ("2026-05-11", 449, 12, 0, None),
    ("2026-05-11", 499, 39, 0, None),
    ("2026-05-11", 699, 3418, 42, 29358),
]
...
cohort_raw = [
    ...
    ("03-03", 563, 30, 210, 13, 310, 696),
    ("03-04", 472, 22, 174, 3, 273, 695),
    ("03-05", 390, 11, 143, 3, 233, 696),
    ("03-06", 932, 31, 336, 7, 558, 697),
    ...
    ("03-14", 1864, 68, 632, 5, 1159, 698),
    ("03-15", 2801, 124, 893, 5, 1779, 698),
    ("03-16", 2548, 105, 836, 10, 1597, 697),
    ("03-17", 3537, 162, 1138, 11, 2226, 697),
    ("03-18", 4337, 176, 1335, 8, 2818, 698),
    ("03-19", 3933, 161, 1183, 9, 2580, 698),
    ...
    ("04-01", 6527, 228, 2193, 5, 4101, 698),
    ("04-02", 6753, 238, 2273, 12, 4230, 698),
    ("04-03", 6943, 240, 2225, 12, 4466, 699),
    ("04-04", 6855, 210, 2249, 10, 4386, 699),
    ("04-05", 7467, 286, 2314, 8, 4859, 699),
    ...
    ("04-26", 11289, 438, 3192, 4836, 2823, 442),
    ...
    ("05-01", 9837, 331, 2817, 4129, 2560, 677),
    ("05-02", 10612, 383, 2921, 4450, 2858, 675),
    ("05-03", 11064, 347, 3121, 4669, 2927, 674),
    ("05-04", 9576, 337, 2779, 3908, 2552, 672),
    ("05-05", 10341, 312, 2836, 4362, 2830, 677),
    ("05-06", 9806, 338, 2718, 4033, 2717, 673),
    ("05-07", 9535, 311, 2683, 3674, 2866, 676),
    ("05-08", 10040, 295, 2775, 4046, 2924, 675),
    ("05-09", 9646, 282, 2483, 3886, 2994, 675),
    ("05-10", 8820, 313, 2079, 4054, 2373, 674),
    ("05-11", 3584, 45, 149, 1186, 1759, 680),
]
