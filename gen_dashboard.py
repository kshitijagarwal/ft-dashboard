...
Data: Mar 1 – May 2, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-01", 689, 1, 689),
    ("2026-05-01", 699, 306, 213894),
    ("2026-05-02", 29, 155, 4495),
    ("2026-05-02", 49, 16, 784),
    ("2026-05-02", 69, 11, 759),
    ("2026-05-02", 99, 45, 4455),
    ("2026-05-02", 198, 1, 198),
    ("2026-05-02", 199, 38, 7562),
    ("2026-05-02", 249, 28, 6972),
    ("2026-05-02", 449, 15, 6735),
    ("2026-05-02", 489, 1, 489),
    ("2026-05-02", 499, 1, 499),
    ("2026-05-02", 689, 1, 689),
    ("2026-05-02", 699, 106, 74094),
]
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-03" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ...
    ["2026-02-15", 699, 36, 4, 2126],
    ["2026-02-16", 4, 1, 1, 4],
    ["2026-02-16", 449, 3, 0, 0],
    ...
    ["2026-04-29", 699, 9814, 488, 289964],
    ["2026-04-30", 198, 37, 1, 198],
    ["2026-04-30", 199, 266, 6, 1194],
    ["2026-04-30", 449, 65, 2, 898],
    ["2026-04-30", 499, 73, 2, 998],
    ["2026-04-30", 689, 69, 2, 1378],
    ["2026-04-30", 699, 10117, 445, 286955],
    ["2026-05-01", 198, 47, 3, 594],
    ["2026-05-01", 199, 294, 17, 3383],
    ["2026-05-01", 449, 89, 3, 1347],
    ["2026-05-01", 499, 72, 1, 499],
    ["2026-05-01", 689, 46, 0, 0],
    ["2026-05-01", 699, 9198, 313, 216787],
    ["2026-05-02", 198, 23, 1, 198],
    ["2026-05-02", 199, 130, 3, 597],
    ["2026-05-02", 449, 24, 0, 0],
    ["2026-05-02", 499, 42, 0, 0],
    ["2026-05-02", 699, 3907, 106, 74094],
]
...
cohort_raw = [
    ...
    ("03-29", 5875, 249, 2061, 4, 3561, 698),
    ("03-30", 5421, 196, 1845, 2, 3378, 697),
    ("03-31", 6679, 259, 1980, 15, 4425, 697),
    ("04-01", 6515, 228, 2186, 3, 4098, 698),
    ("04-02", 6750, 238, 2271, 11, 4230, 699),
    ("04-03", 6935, 240, 2223, 10, 4462, 699),
    ("04-04", 6852, 210, 2249, 9, 4384, 699),
    ("04-05", 7461, 285, 2312, 5, 4859, 699),
    ...
    ("04-10", 7828, 303, 2326, 2, 5197, 687),
    ...
    ("04-24", 10558, 382, 3083, 4269, 2824, 444),
    ("04-25", 9721, 383, 2888, 3909, 2541, 447),
    ("04-26", 11287, 438, 3192, 4835, 2822, 442),
    ("04-27", 11113, 359, 3264, 4473, 3017, 512),
    ("04-28", 10541, 319, 3135, 4298, 2789, 677),
    ("04-29", 10423, 361, 3261, 4222, 2579, 680),
    ("04-30", 10627, 368, 3065, 4428, 2766, 682),
    ("05-01", 9746, 329, 2781, 4119, 2517, 678),
    ("05-02", 4126, 110, 346, 1379, 2291, 677),
]
