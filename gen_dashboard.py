...
Data: Mar 1 – May 7, 2026  (all FT cohorts, DISTINCT-fixed).
...
daily_raw = [
    ...
    ("2026-05-07", 29, 333, 9657),
    ("2026-05-07", 49, 46, 2254),
    ("2026-05-07", 69, 30, 2070),
    ("2026-05-07", 99, 69, 6831),
    ("2026-05-07", 198, 1, 198),
    ("2026-05-07", 199, 85, 16915),
    ("2026-05-07", 249, 41, 10209),
    ("2026-05-07", 449, 44, 19756),
    ("2026-05-07", 499, 1, 499),
    ("2026-05-07", 689, 1, 689),
    ("2026-05-07", 699, 213, 148887),
]
...
att1_daily = {
    ...
    "2026-05-01": (9867, 332),
    "2026-05-02": (10629, 382),
    "2026-05-03": (11005, 347),
    "2026-05-04": (9522, 335),
    "2026-05-05": (10303, 316),
    "2026-05-06": (9754, 339),
    "2026-05-07": (6780, 226),
}
...
for d, amt, comp, rev in daily_raw:
    if d == "2026-05-08" or not comp: continue
    b = bucket_amt(amt)
    if b:
...
pivot_cohort_raw = [
    ...
    ("2026-02-04", 699, 31, 0, None),
    ("2026-02-05", 449, 2, 0, None),
    ("2026-02-05", 489, 1, 0, None),
    ("2026-02-05", 699, 41, 8, 902),
...
cohort_raw = [
    ...
    ("03-02", 399, 20, 154, 4, 221, 692),
    ("03-03", 562, 30, 210, 12, 310, 696),
    ("03-04", 470, 22, 174, 2, 272, 695),
    ("03-05", 389, 11, 143, 2, 233, 697),
    ("03-06", 931, 31, 336, 7, 557, 697),
    ("03-07", 1254, 51, 417, 4, 782, 698),
    ("03-08", 1054, 52, 341, 4, 657, 698),
    ("03-09", 915, 37, 309, 7, 562, 698),
    ("03-10", 208, 8, 82, 5, 113, 691),
    ("03-11", 419, 23, 172, 3, 221, 695),
    ("03-12", 520, 28, 197, 4, 291, 696),
    ("03-13", 1119, 53, 392, 3, 671, 697),
    ("03-14", 1864, 68, 632, 5, 1159, 698),
    ("03-15", 2799, 124, 893, 4, 1778, 698),
    ("03-16", 2545, 105, 835, 10, 1595, 697),
    ("03-17", 3535, 162, 1138, 9, 2226, 697),
    ("03-18", 4337, 176, 1335, 8, 2818, 698),
    ("03-19", 3932, 161, 1182, 9, 2580, 698),
    ("03-20", 3093, 132, 977, 5, 1979, 699),
    ("03-21", 3049, 156, 901, 3, 1989, 699),
    ("03-22", 3213, 150, 963, 4, 2096, 699),
    ("03-23", 3442, 156, 1087, 0, 2199, 696),
    ("03-24", 4137, 173, 1374, 2, 2588, 695),
    ("03-25", 4109, 170, 1433, 4, 2502, 695),
    ("03-26", 4200, 173, 1331, 5, 2691, 697),
    ("03-27", 4636, 215, 1551, 3, 2867, 698),
    ("03-28", 4417, 191, 1548, 5, 2673, 697),
    ("03-29", 5877, 250, 2063, 4, 3560, 698),
    ("03-30", 5422, 196, 1846, 2, 3378, 697),
    ("03-31", 6684, 259, 1984, 16, 4425, 697),
    ("04-01", 6524, 228, 2191, 5, 4100, 698),
    ("04-02", 6754, 238, 2273, 12, 4231, 698),
    ("04-03", 6939, 240, 2223, 12, 4464, 699),
    ("04-04", 6854, 210, 2249, 10, 4385, 699),
    ("04-05", 7463, 285, 2313, 6, 4859, 699),
    ("04-06", 7387, 250, 2326, 5, 4806, 698),
    ("04-07", 8221, 304, 2387, 7, 5523, 696),
    ("04-08", 7743, 291, 2312, 173, 4967, 689),
    ...
    ("04-27", 11149, 363, 3291, 4476, 3019, 512),
    ("04-28", 10681, 321, 3165, 4300, 2895, 675),
    ("04-29", 10534, 362, 3286, 4222, 2664, 678),
    ("04-30", 10694, 371, 3080, 4431, 2812, 681),
    ("05-01", 9837, 331, 2817, 4129, 2560, 677),
    ("05-02", 10592, 381, 2910, 4445, 2856, 675),
    ("05-03", 10974, 347, 3103, 4667, 2857, 675),
    ("05-04", 9494, 334, 2760, 3905, 2495, 674),
    ("05-05", 10263, 311, 2813, 4356, 2782, 678),
    ("05-06", 9724, 339, 2708, 4031, 2628, 674),
    ("05-07", 6763, 225, 1300, 2763, 2356, 677),
]
